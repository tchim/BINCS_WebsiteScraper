...
namespace IMDb_Scraper
{
    public class IMDb
    {
        ...
        public IMDb(string MovieName)
        {
            ...
            new IMDb(MovieName, GetExtraInfo);

        }

        //Default parameter specifiers are not permitted
        public IMDb(string MovieName, bool GetExtraInfo)
        ...
        private string getIMDbUrl(string MovieName)
        {
            ...
            return getIMDbUrl(MovieName, searchEngine);
        }

        private string getIMDbUrl(string MovieName, string searchEngine)
